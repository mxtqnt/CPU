...
int main(void) {
    ...
    if(ir == 19 | ir == 20){
        ...
        if (ir == 19){//ld
            ...
            // MAR 0 0000 0000 0000 0000 0000 0000 0000 1100 <<8

            // MAR 0 0000 0000 0000 0000 0000 1100 0000 0000
            // MAR 1 0000 0000 0000 0000 0000 0000 0000 1010

            // MAR = (memoria[0] << 8) | (memoria[1])
            // MAR = 0000 0000 0000 0000 0000 0000 1100 1010 <<
            //
            //
            
            mbr = memoria[mar++];
            
            // MEMORIA = 1100 1010 1111 1110 1100 1010 1111 1110
            // POSIÇÃO   mar       mar++     mar++     mar++
            //           
